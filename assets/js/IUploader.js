       ...
       if(element.length > 0){
        var element_count = 1;
            ...
            function genrate_inner_html(index,name,file_input,file_data,asset_div,input_name){
                ...
                html += '<div class="iUploader-single-asset-option"><div class="iUploader-single-asset-option-inner remove" data-id="#iUploader-input-01" data-index="'+count_id+'" data-remove=".iUploader-assets-'+count_id+'"><button class="iUploader-button iUploader-button-0'+index+'"><img src="assets/images/icons/trash.png" alt="" class="iUploader-icon"></button>'
